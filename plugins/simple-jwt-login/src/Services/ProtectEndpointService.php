...
class ProtectEndpointService extends BaseService
{
    ...
    {        error_log(print_r("qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqq", true));
        ...
        if (!empty($request['rest_route'])) {
            ...
            error_log(print_r("xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx", true));
    ...
    {
        error_log(print_r("ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff", true));
