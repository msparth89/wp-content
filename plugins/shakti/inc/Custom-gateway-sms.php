...
class Shakti_SMS
{
     ...
     */
     ...
     function sendsms($mobileno, $message){
        ...
        error_log(print_r("SSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSS", true));
...
//        $string = str_replace('${text}', $text, $string);
    ...
    public function lwp_send_sms($phone, $code)
    {
        ...
        // $this->sendsms('919676022920', 'Hello, This is a test message from spring edge');

        $this->sendsms($phone,'Hello, This is a test message from spring edge');


//         error_log(print_r("HHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHhh", true));
//         $method = $this->method;
...
//         }
        ...
        return(array(
            'success' => true,
            'userMessage' => __('Phone number is valid', 'orion-login'),
